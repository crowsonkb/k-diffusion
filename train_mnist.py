...
def main():
    ...
    p.add_argument('--batch-size', type=int, default=100,
                   help='the batch size')
    p.add_argument('--demo-every', type=int, default=300,
                   help='save a demo grid every this many steps')
    p.add_argument('--lr', type=float, default=1e-3,
                   help='the learning rate')
    p.add_argument('--n-to-sample', type=int, default=256,
                   help='the number of images to sample for demo grids')
    p.add_argument('--name', type=str, default='mnist',
    ...
    inner_model = models.ImageDenoiserModel(1, 64, [2, 2, 2], [64, 64, 64], [False, True, True])
